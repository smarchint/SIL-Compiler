...
{
       0,    79,    79,    91,    94,    96,   100,   103,   108,   112,
     114,   118,   122,   126,   131,   135,   139,   147,   149,   154,
     156,   158,   160,   162,   164,   166,   168,   170,   172,   174,
     176,   180,   182,   184,   186,   188,   190,   192,   197,   199
};
#endif
...
/* Line 1455 of yacc.c  */
#line 91 "6.y"
    {(yyval.ptr)=(yyvsp[(2) - (3)].ptr);evaltree((yyval.ptr));}
    break;
...
/* Line 1455 of yacc.c  */
#line 120 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(3) - (5)].ptr),NULL,WRITE,0,DUMMY);if(!type_check((yyval.ptr),0)==1) {printf("1\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 124 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(3) - (5)].ptr),NULL,READ,0,DUMMY);if(!type_check((yyval.ptr),0)==1) {printf("2\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 128 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(3) - (8)].ptr),(yyvsp[(6) - (8)].ptr),IF,0,DUMMY);if(!type_check((yyval.ptr),1)==1){ printf("3\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 133 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(3) - (8)].ptr),(yyvsp[(6) - (8)].ptr),WHILE,0,DUMMY);if(!type_check((yyval.ptr),1)==1) {printf("5\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 137 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (4)].ptr),(yyvsp[(3) - (4)].ptr),'=',0,DUMMY);if(!type_check((yyval.ptr),1)==1) {printf("6\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 141 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (4)].ptr),(yyvsp[(3) - (4)].ptr),'=',0,DUMMY);if(!type_check((yyval.ptr),1)==1) {printf("7\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 154 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),'<',0,DUMMY);	if(!type_check((yyval.ptr),0)==1) {printf("8\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 156 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),'>',0,DUMMY);	if(!type_check((yyval.ptr),0)==1) {printf("9\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 158 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),GE,0,DUMMY);		if(!type_check((yyval.ptr),0)==1) {printf("10\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 160 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),LE,0,DUMMY);		if(!type_check((yyval.ptr),0)==1) {printf("11\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 162 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),NE,0,DUMMY);		if(!type_check((yyval.ptr),0)==1) {printf("12\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 164 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),EQEQ,0,DUMMY);	if(!type_check((yyval.ptr),0)==1) {printf("13\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 166 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(2) - (2)].ptr),NULL,NOT,0,DUMMY);	if(!type_check((yyval.ptr),1)==1) {printf("14\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 168 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),AND,0,DUMMY);	if(!type_check((yyval.ptr),1)==1){printf("15\n");getline();TypeFlag = 0;}}
    break;
...
/* Line 1455 of yacc.c  */
#line 170 "6.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),OR,0,DUMMY);		if(!type_check((yyval.ptr),1)==1) {printf("16\n");getline();TypeFlag = 0;}}
    break;
